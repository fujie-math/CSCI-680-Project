...
from stable_baselines3 import SAC, DSRL_RES_NA
...
def main(cfg: OmegaConf):
	...
	if cfg.algorithm == 'dsrl_sac':
		...
		model = DSRL_RES_NA(
			...
			action_magnitude=cfg.train.action_magnitude,
			noise_magnitude=cfg.train.noise_magnitude,
			res_scale=cfg.train.res_scale,
			noise_scale=cfg.train.noise_scale,
